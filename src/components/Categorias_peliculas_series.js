...
document.addEventListener("DOMContentLoaded", () => {
 ...
 .badge-tipo {
  ...
  // 2. CREACIÓN E INYECCIÓN DE LA ESTRUCTURA HTML
  ...
  contenedorComponente.innerHTML = `
    ...
    <div class="grid">
      <div class="card_categories" data-categoria="Acción">
        ...
        <div class="badge-tipo">Película</div>
        <div class="overlay">
  ...
  // INSERCIÓN CRÍTICA: Aquí es donde se dibuja el componente dentro de la web
  document.body.appendChild(contenedorComponente);
